...
/****** Object:  Database [BLOG]    Script Date: 19.03.2022 20:20:19 ******/
CREATE DATABASE [BLOG]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'BLOG', FILENAME = N'/var/opt/mssql/data/BLOG.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'BLOG_log', FILENAME = N'/var/opt/mssql/data/BLOG_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
